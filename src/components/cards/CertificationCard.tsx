  ...
  >
    ...
    <div className="flex flex-1 flex-col p-5">
      <div className="mb-3 flex flex-wrap items-start justify-between gap-2">
        ...
        <span className="max-w-[48%] truncate pt-1 text-right text-[10px] font-bold uppercase tracking-wider text-[rgba(0,0,0,0.58)]">
      ...
      <div className="mt-auto flex items-center justify-between border-t border-[rgba(0,0,255,0.08)] pt-4 text-xs text-[rgba(0,0,0,0.62)]">
        <div className="flex items-center gap-3">
          <span className="flex items-center gap-1.5"><BarChart className="h-4 w-4 text-[#0000FF]/50" />{programme.level}</span>
          {programme.duration && <span className="flex items-center gap-1.5"><Clock className="h-4 w-4 text-[#0000FF]/50" />{programme.duration}</span>}
        </div>
